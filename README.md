# Easy ticket booking application using listview and popup in MAUI
This example explains about how to prepare a booking application using listview and popup in MAUI.
